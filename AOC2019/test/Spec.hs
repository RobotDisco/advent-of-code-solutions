...
testD2S1T1 = testCase "1,0,0,0,99 becomes 2,0,0,0,99 (1 + 1 = 2)." $ d2s1 [1,0,0,0,99] @?= [2,0,0,0,99]
testD2S1T2 = testCase "2,3,0,3,99 becomes 2,3,0,6,99 (3 * 2 = 6)." $ d2s1 [2,3,0,3,99] @?= [2,3,0,6,99]
testD2S1T3 = testCase "2,4,4,5,99,0 becomes 2,4,4,5,99,9801 (99 * 99 = 9801)." $ d2s1 [2,4,4,5,99,0] @?= [2,4,4,5,99,9801]
testD2S1T4 = testCase "1,1,1,4,99,5,6,0,99 becomes 30,1,1,4,2,5,6,0,99." $ d2s1 [1,1,1,4,99,5,6,0,99] @?= [30,1,1,4,2,5,6,0,99]
